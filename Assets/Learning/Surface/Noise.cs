...
public static class Noise {
	...
	public static float Perlin2D (Vector3 point, float frequency) {
		...
		// pick a random direction for each of the vertices
		...
		// take the dot product of that one with the actual value 
	...
	public static float Sum (NoiseMethod method, Vector3 point, float frequency, int octaves, float lacunary, float persistence) {
